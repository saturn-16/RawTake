  ...
  return (
    <>
      ...
      <section className="verdict">
        ...
        <p>
          <strong>Would trust for placement:</strong>{" "}
          {verdict.verdict.wouldTrustForPlacement ? "Yes" : "No"}
        </p>
...
export default function App() {
  ...
  return (
    <div className="app">
      <h1>RawTake</h1>
      <p className="tagline">No flattery. No hedging. Just the truth about your repo.</p>
          ...
          {previousVerdict && (
            <div className="superseded-verdict">
              ...
              <div className="superseded-body">
                <VerdictBody verdict={previousVerdict} />
              </div>
            </div>
          )}
